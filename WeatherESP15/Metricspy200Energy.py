...
with torch.no_grad():
    ...
    predictions_for_calibrationarea = predictions_for_calibration.reshape(prediction_ensemble_size,341,32,64*prediction_length)
    target_data_test_for_calibrationarea = target_data_test_for_calibration.reshape(341, 32, 64*prediction_length)
    print('area')
    ...
    print('bad')
    predictions_for_calibration = predictions_for_calibration.reshape(prediction_ensemble_size,341,32*64*prediction_length)
    target_data_test_for_calibration = target_data_test_for_calibration.reshape(341, 32*64*prediction_length)
    print(predictions_for_calibration.shape)
    print(target_data_test_for_calibration.shape)
