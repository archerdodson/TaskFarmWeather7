...
args_dict = {}
weight_decay, scheduler_gamma, lr, epochs, early_stopping, epochs_early_stopping_interval = 0, 1, 0.00001, 200, True, 10 #Original Learning rate 0.01 
...
name_postfix = f"_mytrainedmodelEnergyScore_lr{lr:.0e}"  # or something else descriptive
nets_folder = "results/nets/"
