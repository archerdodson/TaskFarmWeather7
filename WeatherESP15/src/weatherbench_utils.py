...
def load_weatherbench_data(weatherbench_data_folder, cuda, load_all_data_GPU, return_test=False,
    ...
    dataset_train = WeatherBenchDataset(data.sel(time=slice('2014', '2016')), var_dict, lead_time, window_size,
    ...
    dataset_val = WeatherBenchDataset(data.sel(time='2017'), var_dict, lead_time, window_size,
