...
with torch.no_grad():
    ...
    predictions_for_calibration = predictions_for_calibration.reshape(prediction_ensemble_size,1996,data_size*prediction_length)
    target_data_test_for_calibration = target_data_test_for_calibration.reshape(1996, data_size*prediction_length)
...
with torch.no_grad():
    ...
    predictions_test = predictions_test.reshape(1996, prediction_ensemble_size,data_size)
    target_data_test = target_data_test.reshape(1996, data_size)
